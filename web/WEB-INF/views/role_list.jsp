...
<table width="90%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >用户管理->职务列表</th>
  </tr>
  <tr>
    <td class="CPanel">
        ...
        <tr>
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#FFFFEE" class="newfont03">
				 <tr class="CTitle" >
                    	<td height="22" colspan="4" align="center" style="font-size:16px">职务详细列表</td>
                  </tr>
                  <tr bgcolor="#EEEEEE">
				    <td width="15%" height="30">职务ID</td>
					<td width="40%">职务名称</td>
					<td width="">操作</td>
                  </tr>
                  <c:forEach items="${groups}" var="var" varStatus="vs">
                  <tr  <c:if test="${vs.count%2==0}">bgcolor="#AAAABB"</c:if> align="left" >
				    <td >${var.getRole_id()}</td>
				    <td  height="30">${var.getRolename()}</td>                  
					<td ><a href="<%=basePath%>role/view/${var.getRole_id()}">查看</a>&nbsp;
					<a href="<%=basePath%>role/edit/${var.getRole_id()}">编辑</a>&nbsp;
					<a href="<%=basePath%>role/delete/${var.getRole_id()}">删除</a>&nbsp;
					</td>
                  </tr>
                  </c:forEach>
            </table></td>
