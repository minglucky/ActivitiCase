...
<table width="90%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >用户管理->新增部门</th>
  </tr>
  <tr>
    <td class="CPanel">
                ...
                <TD width="100%">
                    ...
                    <legend>添加部门</legend>
                          ...
                          <tr>
                            ...
                            <td width="41%"><input name="department_id" id="department_id" class="text" style="width:250px" type="text" size="40" />
                            <span class="red"> *</span></td>
                          </tr>
                          <tr>
                            <td nowrap align="right" width="13%">部门名称:</td>
                            <td width="41%"><input name="departmentname" id="departmentname" class="text" style="width:250px" type="text" size="40" />
                            <span class="red"> *</span></td>
                          </tr>
                          </table>
                    </fieldset>			
