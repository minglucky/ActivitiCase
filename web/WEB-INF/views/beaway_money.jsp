...
<table width="90%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >休假出差管理->填写借钱单据</th>
  </tr>
  <tr>
    <td class="CPanel">
            ...
            <TR>
                <TD width="100%">
                    <fieldset style="height:100%;">
                       <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
                          <tr>
                            <th nowrap align="right" width="13%">借钱:</th>
                            <th align="left" width="41%"></th>
                          </tr>
                          <tr>
                            <td nowrap align="right" width="13%">金额:</td>
                            <td width="41%">
								<input name="borrowmoney" id="borrowmoney" value="" class="text" style="width:250px" type="text" size="40" />元
                            <span class="red"> *</span>
							</td>
                          </tr>
                        </table>
