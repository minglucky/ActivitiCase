...
<table width="90%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >休假出差管理->财务职员审核</th>
  </tr>
  <tr>
    <td class="CPanel">
            ...
            <TR>
                <TD width="100%">
                    <fieldset style="height:100%;">
                       <table border="0" cellpadding="2" cellspacing="1" style="width:100%">
                          <tr>
                            <th nowrap align="right" width="13%">申请派车:</th>
                            <th align="left" width="41%"></th>
                          </tr>
                          <tr>
                            <td nowrap align="right" width="13%">派车时间:</td>
                            <td width="41%"><input name="pstartdatetime" id="pstartdatetime" class="text" style="width:250px" type="text" size="40" onClick="WdatePicker({ dateFmt: 'yyyy-MM-dd HH:mm:ss' })"/>
                          ...
                          <tr>
                            <td nowrap align="right" width="13%">联系电话:</td>
                            <td width="41%"><input name="phone" id="phone" class="text" style="width:250px" type="text" size="40" value="${data.phone}" />
                            <span class="red"> *</span></td>
                          </tr>
                        </table>
                    </fieldset>			
